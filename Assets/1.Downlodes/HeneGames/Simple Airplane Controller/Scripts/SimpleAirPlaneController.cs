...
//
           // inputH = TCKInput.GetAxis( "Joystick", EAxisType.Horizontal );
           // inputV = TCKInput.GetAxis( "Joystick", EAxisType.Vertical );
//
            //Yaw axis inputs
            inputYawLeft = Input.GetKey(KeyCode.Q);
            inputYawRight = Input.GetKey(KeyCode.E);

            //inputYawLeft = TCKInput.GetAction( "left", EActionEvent.Press);
            //inputYawRight = TCKInput.GetAction( "right", EActionEvent.Press);

            //Turbo
           // inputTurbo = Input.GetKey(KeyCode.LeftShift);
           // inputTurbo = TCKInput.GetAction( "fireBtn", EActionEvent.Press);
           // inputTurbo = FOVmode;
